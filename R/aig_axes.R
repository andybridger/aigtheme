...
#' @examples
#'
#' # Here's a basic chart in the aig style:
#' library(ggplot2)
#'
...
scale_y_continuous_aig <- function(expand_bottom = 0,
                                       expand_top = 0.07,
                                       ...) {
  
  aig_y_continuous(expand_bottom = expand_bottom,
...
aig_x_continuous <- function(expand_left = 0,
                                 expand_right = 0.07,
                                 ...) {
...
scale_x_continuous_aig <- function(expand_left = 0,
                                       expand_right = 0.07,
                                       ...) {
  
  aig_x_continuous(expand_left = expand_left,
